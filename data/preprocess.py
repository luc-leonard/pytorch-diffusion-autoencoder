...
def batch_resize_images(image_folder, output_folder, size):
    ...
    it = pool.imap(partial(resize_image, base_folder=image_folder, size=size, output_folder=output_folder), input_files)
...
batch_resize_images('/media/lleonard/big_slow_disk/datasets/ffhq/images1024x1024/', './data/images_resized', (64, 64))